...
# ---------------------------------------------------------------------------
# TestKeyValueBasics (Go: TestKeyValueBasics)
# ---------------------------------------------------------------------------
class TestKeyValueBasics:
    async def test_put_and_get(self, jetstream: JetStream):
    ...
    async def test_invalid_key_put(self, jetstream: JetStream):
    ...
    async def test_invalid_key_get(self, jetstream: JetStream):
    ...
    async def test_invalid_key_delete(self, jetstream: JetStream):
    ...
    async def test_delete_and_recreate(self, jetstream: JetStream):
    ...
    async def test_delete_with_last_revision(self, jetstream: JetStream):
    ...
    async def test_conditional_update(self, jetstream: JetStream):
    ...
    async def test_status(self, jetstream: JetStream):
    ...
    async def test_bucket_property(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestCreateKeyValue (Go: TestCreateKeyValue)
# ---------------------------------------------------------------------------
class TestCreateKeyValue:
    async def test_invalid_bucket_name(self, jetstream: JetStream):
    ...
    async def test_history_too_large(self, jetstream: JetStream):
    ...
    async def test_duplicate_bucket(self, jetstream: JetStream):
    ...
    async def test_stream_config(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueCreate (Go: TestKeyValueCreate)
# ---------------------------------------------------------------------------
class TestKeyValueCreate:
    async def test_create_new_key(self, jetstream: JetStream):
    ...
    async def test_create_existing_key(self, jetstream: JetStream):
    ...
    async def test_create_after_delete(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueGetRevision (Go: TestKeyValueGetRevision)
# ---------------------------------------------------------------------------
class TestKeyValueGetRevision:
    async def test_get_specific_revision(self, jetstream: JetStream):
    ...
    async def test_get_deleted_revision(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueDeleteVsPurge (Go: TestKeyValueDeleteVsPurge)
# ---------------------------------------------------------------------------
class TestKeyValueDeleteVsPurge:
    async def test_delete_preserves_history(self, jetstream: JetStream):
    ...
    async def test_purge_removes_history(self, jetstream: JetStream):
    ...
    async def test_purge_with_last_revision(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueHistory (Go: TestKeyValueHistory)
# ---------------------------------------------------------------------------
class TestKeyValueHistory:
    async def test_history_with_limit(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueKeys (Go: TestKeyValueKeys)
# ---------------------------------------------------------------------------
class TestKeyValueKeys:
    async def test_empty_bucket(self, jetstream: JetStream):
    ...
    async def test_list_keys(self, jetstream: JetStream):
    ...
    async def test_keys_excludes_deleted(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueWatch (Go: TestKeyValueWatch)
# ---------------------------------------------------------------------------
class TestKeyValueWatch:
    async def test_default_watcher(self, jetstream: JetStream):
    ...
    async def test_watcher_with_existing_data(self, jetstream: JetStream):
    ...
    async def test_watcher_with_history(self, jetstream: JetStream):
    ...
    async def test_watcher_updates_only(self, jetstream: JetStream):
    ...
    async def test_watcher_include_history_and_updates_only_conflict(self, jetstream: JetStream):
    ...
    async def test_watcher_wildcard(self, jetstream: JetStream):
    ...
    async def test_watcher_purge_operation(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
class TestKeyValueBindStore:
    async def test_bind_existing(self, jetstream: JetStream):
    ...
    async def test_bind_nonexistent(self, jetstream: JetStream):
        """Bind to a non-existent bucket raises BucketNotFoundError."""
        with pytest.raises(BucketNotFoundError):
            await key_value(jetstream, "NONEXISTENT")

    async def test_bind_invalid_name(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueDeleteStore (Go: TestKeyValueDeleteStore)
# ---------------------------------------------------------------------------
class TestKeyValueDeleteStore:
    async def test_delete_bucket(self, jetstream: JetStream):
        """Delete a bucket."""
        await create_key_value(jetstream, KeyValueConfig(bucket="TEST"))
    ...
    async def test_delete_nonexistent(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueDeleteTombstones (Go: TestKeyValueDeleteTombstones)
# ---------------------------------------------------------------------------
class TestKeyValueDeleteTombstones:
    async def test_purge_deletes(self, jetstream: JetStream):
...
# ---------------------------------------------------------------------------
# TestKeyValueStatusBytes (Go: TestKeyValueStatusBytes)
# ---------------------------------------------------------------------------
class TestKeyValueStatusBytes:
    async def test_status_bytes(self, jetstream: JetStream):
...
class TestKeyNotFound:
    async def test_get_nonexistent(self, jetstream: JetStream):
