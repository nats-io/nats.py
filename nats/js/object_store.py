...
class ObjectStore:
    ...
    async def put(self, meta: api.ObjectMeta, data: bytes) -> api.ObjectInfo:
        ...
        chunk_subj = OBJ_CHUNKS_PRE_TEMPLATE.format(bucket=self._name, obj=id.decode())
        ...
        try:
            ...
            await self._js.purge_stream(self._stream, api.StreamPurgeRequest(filter=chunk_subj))
            raise e
